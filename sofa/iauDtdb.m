...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function w = iauDtdb(date1, date2, ut, elong, u, v)
...
% Sun Mean Longitude.
elsun = mod(280.46645683 + 1296027711.03429 * w, 360.0) * DD2R;

% Sun Mean Anomaly.
emsun = mod(357.52910918 + 1295965810.481 * w, 360.0) * DD2R;

% Mean Elongation of Moon from Sun.
d = mod(297.85019547 + 16029616012.090 * w, 360.0) * DD2R;

% Mean Longitude of Jupiter.
elj = mod(34.35151874 + 109306899.89453 * w, 360.0) * DD2R;

% Mean Longitude of Saturn.
els = mod(50.07744430 + 44046398.47038 * w, 360.0) * DD2R;

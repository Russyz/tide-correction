function [MJD_UTC, TAI_UTC, UT1_UTC, x_p, y_p, dX,dY] = get_eop2(YR,MONTH,DATE,hour,min,sec)
...
dx = EOP_DATA(:,9);
dy = EOP_DATA(:,10);
x_p =lagint(MJD,x,MJD_UTC,4);
y_p = lagint(MJD,y,MJD_UTC,4);
dX =lagint(MJD,dx,MJD_UTC,4);
dY = lagint(MJD,dy,MJD_UTC,4);
